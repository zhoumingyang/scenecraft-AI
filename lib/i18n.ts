...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    "editor.ai3d.helperText": "Preview a stylized low-poly sketch with mixed geometry before applying it to the scene.",
  ...
  zh: {
    ...
    "editor.ai3d.helperText": "先预览混合几何的风格化低模草图，确认后再写入场景。",
